...
export default function Navbar() {
  return (
    <nav className="w-full h-[120px] sm:h-[120px] bg-[#2B3A67] px-4 py-4 sm:py-6 drop-shadow-xl border-b border-gray-700">
      <div className="w-full max-w-[800px] mx-auto h-full flex justify-between items-center">
        ...
        <div className="flex items-center justify-center w-[50px] h-[50px] sm:w-[60px] sm:h-[60px]">
          <Link href={"/settings"}className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:scale-110 ">
            <Settings className="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] text-white hover:text-gray-300  transition-all hover:rotate-12" />
          </Link>
        </div>
        ...
        {/* logout */}
        <div className="flex items-center justify-center w-[50px] h-[50px] sm:w-[60px] sm:h-[60px]">
          <Link href={"/auth/signin"}className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:scale-110 ">

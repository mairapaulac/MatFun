...
export default function LandingPage() {
  ...
  const carouselImages = [
    "/0a85f77b-e11d-4565-8285-c9011933a7c9.PNG",
    "/c6c3dc17-9851-4a70-a217-4bf558029746.jfif",
    "/d52fdec3-6c2b-4512-ba9a-0e2f96f25225.jfif",
    "/eec63991-c253-4556-872e-bab2d6205e1e.jfif",
  ];
  return (
    <div className="bg-background text-white min-h-screen w-screen overflow-x-hidden">
      ...
      <main className="text-center py-20 px-8 bg-pattern">
        ...
        <h2 className="text-5xl font-normal mb-4 text-shadow">
          Aprenda Matemática Jogando!
        </h2>
        <p className="text-lg max-w-2xl mx-auto mb-8 text-shadow">
          Uma plataforma divertida que ajuda alunos da rede pública a dominar a
          matemática e se preparar para o SAEB.
        </p>
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <Button
            onClick={() => router.push("/auth/signup")}
            size="lg"
            className="w-full md:w-auto transition-all duration-300 hover:scale-105 active:scale-95 rounded-4xl"
          >
      ...
      <section
        id="como-funciona"
        className="py-20 px-8 bg-white  text-gray-800"
      >
        <h3 className="text-4xl font-normal text-center mb-12">
          Como Funciona
        </h3>
      ...
      <section id="carousel-section" className="py-20 px-8 bg-pattern">
        <h3 className="text-4xl font-normal text-center mb-12 text-shadow" >Crianças Aprendendo na Prática</h3>
        <Carousel>
          <CarouselContent>
            {carouselImages.map((src, index) => (
              ...
              >
                <Image
                  ...
                  width={400}
                  height={280}
                  className="w-[400px] h-[280px] object-cover mx-auto rounded-xl"
                />
              </CarouselItem>
            ))}
          </CarouselContent>
          <CarouselPrevious className="absolute left-2 top-1/2 -translate-y-1/2 z-10 text-white rounded-full shadow-lg bg-black/20 hover:bg-black/40" />
          <CarouselNext className="absolute right-2 top-1/2 -translate-y-1/2 z-10 text-white rounded-full shadow-lg bg-black/20 hover:bg-black/40" />
        </Carousel>
      </section>

      <section id="modulos" className="py-20 px-8 bg-white text-gray-800">
        <h3 className="text-4xl font-normal text-center mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Resolva equações, domine expressões e prepare-se para desafios
              algébricos.
            </p>
          </div>
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Calcule áreas, perímetros e explore as formas geométricas de
              maneira interativa.
            </p>
          </div>
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Some, subtraia, multiplique e divida frações de forma divertida e
              visual.
            </p>
          </div>
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Entenda e aplique porcentagens em situações do dia a dia, como
              descontos e juros.
            </p>
          </div>
        </div>
      ...
      {/* Ranking Section */}
      <section id="ranking" className="py-20 px-8 bg-pattern">
        <h3 className="text-4xl font-normal text-center mb-12 text-shadow">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-800 text-white">
            ...
            <p>
              Veja sua posição no ranking de alunos, turmas e escolas. A
          ...
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-800 text-white">
            ...
            <p>
              Desbloqueie conquistas ao atingir objetivos, como completar
          ...
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-800 text-white">
            ...
            <p>
              Ganhe medalhas de ouro, prata e bronze por seu desempenho
              excepcional e mostre seu progresso.
            </p>
          </div>
        </div>
      </section>

      <section id="educadores" className="py-20 px-8 bg-white text-gray-800">
        <h3 className="text-4xl font-normal text-center mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Monitore o progresso de seus alunos em tempo real, identificando
          ...
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Receba relatórios detalhados por aluno, turma ou habilidade,
          ...
          <div className="text-center p-6 rounded-lg shadow-lg bg-gray-50">
            ...
            <p>
              Crie e atribua listas de exercícios personalizadas para atender às
      ...
      <section id="depoimentos" className="py-24 px-8 bg-pattern">
      ...
      <section id="seguranca" className="py-20 px-8 bg-white text-gray-800">
        <h3 className="text-4xl font-normal text-center mb-12">
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p>
            Plataforma segura, sem anúncios, que respeita a privacidade dos
            alunos e é acessível em diversos dispositivos.
          </p>
        </div>
      </section>

      <section className="py-20 px-8 text-center bg-pattern">
        <h3 className="text-4xl font-normal mb-4 text-shadow">
          Pronto para entrar no jogo?
        </h3>
        <Button
          onClick={() => router.push("/auth/signup")}
          size="lg"
          className="transition-all duration-300 hover:scale-105 active:scale-95 rounded-bl-4xl rounded-tr-4xl"
        >
          Começar Agora!
        </Button>
      </section>
